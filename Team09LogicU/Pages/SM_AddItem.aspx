...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
                ...
                <div class="container">
                    ...
                    <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            <asp:RegularExpressionValidator runat="server" ForeColor="Red" ID="text_box_qty_alert" ValidationGroup="submit1" ControlToValidate="TextBox_qty" ValidationExpression="^[1-9]\d*|0$" ErrorMessage="Invalid!"></asp:RegularExpressionValidator>
                    ...
                    <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            <asp:RegularExpressionValidator runat="server" ForeColor="Red" ID="text_box_level_alert" ValidationGroup="submit1" ControlToValidate="TextBox_ReorderLevel" ValidationExpression="^[1-9]\d*$" ErrorMessage="Invalid!"></asp:RegularExpressionValidator>
                    ...
                    <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            <asp:RegularExpressionValidator ID="text_box_reorderqty_alert" runat="server" ForeColor="Red" ValidationGroup="submit1" ControlToValidate="TextBox_ReorderQty" ValidationExpression="^[1-9]\d*$" ErrorMessage="Invalid!"></asp:RegularExpressionValidator>
                            <%-- value=""--%>
                        </div>
                    </div>
                    <div class="col-lg-4">
                    ...
                    <div class="col-lg-4" style="margin-top: 20px; margin-bottom: 20px">
                        <div class="form-group">
                            ...
                            <asp:RegularExpressionValidator ID="text_box_Supplier1_alert" runat="server" ForeColor="Red" ValidationGroup="submit1" ControlToValidate="TextBox_price1" ValidationExpression="^[+]{0,1}(\d+)$|^[+]{0,1}(\d+\.\d+)$" ErrorMessage="Invalid!"></asp:RegularExpressionValidator>
                    ...
                    <div class="col-lg-4" style="margin-top: 20px; margin-bottom: 20px">
                        <div class="form-group">
                            ...
                            <asp:RegularExpressionValidator ID="text_box_Supplier2_alert" runat="server" ForeColor="Red" ValidationGroup="submit1" ControlToValidate="TextBox_price2" ValidationExpression="^[+]{0,1}(\d+)$|^[+]{0,1}(\d+\.\d+)$" ErrorMessage="Invalid!"></asp:RegularExpressionValidator>
                    ...
                    <div class="col-lg-4" style="margin-top: 20px; margin-bottom: 20px">
                        <div class="form-group">
                            ...
                            <asp:RegularExpressionValidator ID="text_box_Supplier3_alert" runat="server" ForeColor="Red" ValidationGroup="submit1" ControlToValidate="TextBox_price3" ValidationExpression="^[+]{0,1}(\d+)$|^[+]{0,1}(\d+\.\d+)$" ErrorMessage="Invalid!"></asp:RegularExpressionValidator>
    ...
    <script type="text/javascript">
        ...
        function notEmpty() {
            var not_empty = true;
            if (!$('#TextBox_qty').val()) {
                $('#text_box_qty_alert').text('Invalid!').css('visibility', 'visible');
            }
