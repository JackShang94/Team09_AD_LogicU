...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <form runat="server">
        Current Role:
        <asp:Label ID="Label_logInRole" runat="server" Text="" EnableViewState="true"></asp:Label>
        <div>
            <asp:Panel ID="Panel_submitDelegate" runat="server">
                <h3>Delegate to:
                <asp:Label ID="delegateStf_label" runat="server" Text=""></asp:Label></h3>
                Employee: 
            <asp:DropDownList ID="employee_dropList" runat="server"></asp:DropDownList>
                From:      
        ...
        <asp:GridView ID="GridView_dHistory" runat="server" >
            <Columns>
