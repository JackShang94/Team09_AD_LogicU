                    ...
                    <div class="col-lg-12">
                        <div class="card">
                         ...
                         <asp:Button ID="Button_Add"  runat="server" Text="Add New Supplier"  CssClass="btn btn-danger btn-fill btn-wd " OnClick="Button_Add_Click" />
                                     ...
                                     <asp:GridView ID="GridView_supplierList" runat="server"   CssClass="table bootstrap-table table-hover table-striped" HeaderStyle-CssClass=" content text-uppercase  "  AllowPaging="True" EditRowStyle-CssClass="btn btn-warning btn-fill fa fa-edit" 
                                         AutoGenerateDeleteButton="True" 
                                         AutoGenerateEditButton="True" 
                                         AutoGenerateSelectButton="True" CellPadding="4" ForeColor="#333333" GridLines="None"></asp:GridView>   
