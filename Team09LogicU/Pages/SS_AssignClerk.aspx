...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <div class="col-md-6">
                                <legend>Clerk Select</legend>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <asp:Label ID="Label_CollectionPoint1" runat="server" ></asp:Label>
                                   ...
                                   <asp:dropdownlist ID="dropdownlist5" runat="server" class="form-control"  Width="200px"></asp:dropdownlist>
                                            ...
                                            <asp:Label ID="Label_CollectionPoint6" runat="server" ></asp:Label>
