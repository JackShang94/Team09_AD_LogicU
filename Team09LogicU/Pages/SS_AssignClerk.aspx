                    ...
                    <div class="col-lg-10" >
                        ...
                        <div class=" container" >
                               <div class="col-lg-10" style="margin-top: 20px; margin-bottom: 20px">
                                   ...
                                   <asp:GridView ID="GridView1" CssClass="table table-striped  table-hover" runat="server" ShowHeaderWhenEmpty="true" HeaderStyle-CssClass="text-uppercase" EmptyDataText="there is no information!"></asp:GridView>
                                    </div></div></div></div></div>
                                    <div class="row">
                                        <div class="col-lg-10" >
                        <div class="card">
                        <div class=" container" >
                            ...
                            <div class="col-lg-4" style="margin:20px 0 20px 0">
                                ...
                                </div><div class="col-lg-4" style="margin:20px 0 20px 0">
